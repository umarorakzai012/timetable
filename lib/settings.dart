        ...
        body: ListView(
          children: <Widget>[
            SwitchListTile(
              ...
              secondary: Icon(Provider.of<ModelTheme>(context).isDark
                  ? Icons.dark_mode
                  : Icons.light_mode),
            ...
            SwitchListTile(
              ...
              subtitle: const Text(
                  "Keeps the course list selection across different uploads."),
              isThreeLine: true,
